...
class Endzone(pygame.sprite.Sprite):
    ...
    """If a Player reaches the Endzone, the last image of the Player will be rendered 
    instead of the transparent rect
    Gives the illusion of the Player still standing in the Endzone"""
